    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-danger">
                <div class="panel-heading">Management LogIn</div>
                <div class="panel-body">
                    <form method="POST" action="{{ route('management.login.submit') }}">
                         {{ csrf_field() }}

                        <label for="email">Email</label>
                        <input id="email" type="email" class="form-control" name="email" required title="Admin Email">
                        <br>
                        <label for="password">Password</label>
                        <input id="password" type="password" class="form-control" name="password" required title="Admin Password">
                        <br>
