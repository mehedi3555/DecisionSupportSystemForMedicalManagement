        ...
        <div class="col-md-8 col-md-offset-2 agile-last-left agile-last-middle">
          <div class="agile-last-grid">
            ...
            <?php
              ...
              ->select(DB::raw('YEAR(Date) as year'), 'diseases.Name as dName', DB::raw('count(patients.id) as totalPatient'))
              ->groupBy(DB::raw('YEAR(Date), diseases.id'))
              ->get();
            ?>
            ...
            var day_data = [
              @foreach ($patients as $data)
                {"year": "{{ $data->dName }}" + "</br>" + ".Year : {{ $data->year }}", "patients": {!! $data->totalPatient !!}},
              @endforeach
            ];
...
<div id="pdf">
  ...
  <p style="font-size: 25px !important; color: #712828 !important; text-align: center; font-family: sans-serif;font-weight:700 !important;margin-top: 0px !important">
    Report Based on Patient Diseases (Yearly)
  </p>

  <table style="width: 100% !important;" class="table table-striped" cellpadding="10" cellspacing="0">
      <tr>
        <th style="border-bottom: 2px solid #8c7f7f !important;text-align: left; font-size: 22px !important; font-weight: 700 !important; color:#0B62A4 !important; font-family: sans-serif;">Year</th>
    ...
    @foreach($patients as $data)
      <tr>
        <td style="border-bottom: 2px solid #ddd !important;text-align: left; font-size: 18px !important; font-weight: 700 !important;font-family: sans-serif;">{{ $data->year }}</td>
