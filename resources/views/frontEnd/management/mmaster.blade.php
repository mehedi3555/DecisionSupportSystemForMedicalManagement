...
@include('frontEnd.management.include.header')
@include('frontEnd.management.include.sidebar')

@yield('main-content')

@include('frontEnd.management.include.footer')
